...
class Calculator extends React.Component {
  ...
  calculateExtraPayments() {
    ...
    this.setState({ calcExtraPay: result, runExtras: runExtras }, () =>
      this.runAllCalcs()
    );
  }
  ...
  runCals() {
    ...
    return this.setState({
      calcs: data,
      calcsTotalInt: totalInt,
      calcsTotalPay: totalPay,
      displayAmort: true
    });
  }
  ...
  runExtraCals() {
    ...
    for (let i = 0; i < iterations; i++) {
      ...
      if (calcPrinciple <= 0) {
        ...
        return this.setState({
          extraCalcs: extraData,
          extraTotalInt: totalInt,
          extraTotalPay: totalPay,
          totalMonths: i
        });
      }
      let interest = Math.round(calcPrinciple * monthInt * 100) / 100;
    ...
    return (
      <>
        <div className="gridcontainer">
          ...
          <label className="grid-loan-amt">
            New Loan Amount or Existing Loan Balance
          </label>
          <input
            className="grid-loan-entry"
            type="text"
            name="principle"
          ...
          <label className="grid-interest">
            {" "}
            Enter Interest Rate (ex. 7.5):{" "}
          </label>
          <input
            className="grid-interest-entry"
            type="text"
            name="interest"
            value={this.state.interest}
            onChange={this.handleInput("interest")}
          ></input>

          <label className="grid-duration">
            {" "}
            Enter Duration in Months (ex. 360):{" "}
          </label>
          <input
            className="grid-duration-entry"
            type="text"
            name="duration"
        ...
        <div className="extra-pay-grid">
          <div className="grid-extra-header">
          ...
          <input
            type="text"
            name="epAmount1"
            value={this.state.ep1.amount}
            onChange={this.handleExtraInput("amount", "ep1")}
          ></input>
          <input
            type="text"
            name="epStart1"
            value={this.state.ep1.start}
            onChange={this.handleExtraInput("start", "ep1")}
          ></input>
          <input
            type="text"
            name="epEnd1"
            value={this.state.ep1.end}
            onChange={this.handleExtraInput("end", "ep1")}
          ></input>
          ...
          <input
            type="text"
            name="epAmount2"
            value={this.state.ep2.amount}
            onChange={this.handleExtraInput("amount", "ep2")}
          ></input>
          <input
            type="text"
            name="epStart2"
            value={this.state.ep2.start}
            onChange={this.handleExtraInput("start", "ep2")}
          ></input>
          <input
            type="text"
            name="epEnd2"
            value={this.state.ep2.end}
            onChange={this.handleExtraInput("end", "ep2")}
          ></input>
          ...
          <input
            type="text"
            name="epAmount3"
            value={this.state.ep3.amount}
            onChange={this.handleExtraInput("amount", "ep3")}
          ></input>
          <input
            type="text"
            name="epStart3"
            value={this.state.ep3.start}
            onChange={this.handleExtraInput("start", "ep3")}
          ></input>
          <input
            type="text"
            name="epEnd3"
            value={this.state.ep3.end}
            onChange={this.handleExtraInput("end", "ep3")}
          ></input>
          ...
          <input
            type="text"
            name="epAmount4"
            value={this.state.ep4.amount}
            onChange={this.handleExtraInput("amount", "ep4")}
          ></input>
          <input
            type="text"
            name="epStart4"
            value={this.state.ep4.start}
            onChange={this.handleExtraInput("start", "ep4")}
          ></input>
          <input
            type="text"
            name="epEnd4"
            value={this.state.ep4.end}
            onChange={this.handleExtraInput("end", "ep4")}
          ></input>
        </div>
        ...
        <button
          className="buttons"
          id="button-calc"
          onClick={this.calculateExtraPayments}
        >
          Calculate
        </button>
        <button
